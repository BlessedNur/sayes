...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-button-2 text-global-1 hover:bg-yellow-400 active:bg-yellow-500 focus:ring-yellow-500',
    secondary: 'bg-button-1 text-global-4 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
